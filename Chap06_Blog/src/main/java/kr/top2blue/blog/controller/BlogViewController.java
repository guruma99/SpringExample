...
import org.springframework.ui.Model; //Model은 현재 스프링을 사용하고 있기 떄문에 springframework.ui.Model 임포트해야한다.
...
//======================================================	
	...
	// @PathVariable : 주소의 뒷부분에 (경로받기){id}라고 쓴 값을 받겠다.
	public String getArticle(@PathVariable Long id, Model model) {
		// 경로로 넘어온 글번호를 이용하여 서비스를 호출해서 해당 글번호의 내용을 가져오고
		// 모델에 담아 뷰페이지로 이동한다.
		// 1. @PathVariable로 글 번호를 이미 받았다.
		// 2. 서비스를 호출해서 해당 글 번호의 내용을 가져오고
...
// ======================================================
	// 새글쓰기/수정하기 구현
	// new-article : 새글쓰기 Model이 필요없지만 수정할 때 필요함
